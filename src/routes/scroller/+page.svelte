...
<div class="stack fluid blur-mask-top">
...
<style>
	* {
	...
	/* .blur-mask-bottom {
		...
		mask-image: linear-gradient(to bottom, rgb(0, 0, 0) 94%, transparent);
	} */
</style>
